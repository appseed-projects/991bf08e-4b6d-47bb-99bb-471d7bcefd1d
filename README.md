...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-01 05:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/991bf08e-4b6d-47bb-99bb-471d7bcefd1d.git
$ cd 991bf08e-4b6d-47bb-99bb-471d7bcefd1d
```
